      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in animation-delay-1000 items-center">
              <a 
                ...
                className="bg-[#C9A34C] hover:bg-[#B8923E] text-black px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg transform text-center w-full sm:flex-none sm:min-w-[200px]"
              >
                Investor Login
              </a>
              <button className="border-2 border-[#C9A34C] hover:bg-[#C9A34C] hover:text-black text-[#C9A34C] px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg transform text-center w-full sm:flex-none sm:min-w-[200px]">
                Schedule Intro Call
              </button>
            </div>
          </div>
