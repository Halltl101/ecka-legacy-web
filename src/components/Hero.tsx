          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in animation-delay-1000">
              <a 
                ...
                className="bg-[#C9A34C] hover:bg-[#B8923E] text-black px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg transform text-center flex-1 sm:flex-none sm:min-w-[200px]"
              >
                Investor Login
              </a>
              <button className="border-2 border-[#C9A34C] hover:bg-[#C9A34C] hover:text-black text-[#C9A34C] px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg transform text-center flex-1 sm:flex-none sm:min-w-[200px]">
                Schedule Intro Call
              </button>
            </div>
          </div>
