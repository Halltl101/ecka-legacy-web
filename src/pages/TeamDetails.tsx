...
const TeamDetails = () => {
  ...
  const teamMembers = [
    ...
    { name: "Ric Aliberte", role: "Acquisitions Lead", bio: "Legendary music executive with more than five decades of experience across promotion, A&R, and artist management. Former executive at Elektra/Asylum Records and RCA who worked with iconic artists including Queen, KISS, The Eagles, and The Doors. Founder of artist management company RAM Inc.", image: "/lovable-uploads/518559b1-d3b2-4b65-8c84-f8cc2d6f9bf7.png" },
