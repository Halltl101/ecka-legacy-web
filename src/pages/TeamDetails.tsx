...
const TeamDetails = () => {
  ...
  const teamMembers = [
    ...
    { name: "Alex Benton", role: "Chief Operating Officer", bio: "Howard University and Harvard Business School alum with experience spanning music, film, and entertainment investment. Has produced award-winning film projects and led creative campaigns for artists signed to Capitol Records and Atlantic Records.", image: "/lovable-uploads/4a46e31a-7f5b-4183-836a-bcbdcfc78e8e.webp" },
    { name: "Erik Steigen", role: "VP Publishing", bio: "20+ years of experience in publishing and royalty administration. Has managed catalogs for artists including Lionel Richie, Brian Wilson, and Don Felder. Founder of USA Media Rights®.", image: "/lovable-uploads/387678dd-6e24-416b-bf4f-715083b5f5d0.webp" },
    ...
    { name: "Sean Collins", role: "VP of A&R and M&A", bio: "25+ years music industry veteran. Collaborated with major artists including Jay-Z, Chris Brown, and 50 Cent. Successfully negotiated deals with Warner Chappell, Sony ATV, and Empire.", image: "/lovable-uploads/15691bfc-f7ef-42ae-96d3-ad4fd5f13a79.webp" },
